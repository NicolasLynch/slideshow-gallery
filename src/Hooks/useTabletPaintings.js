/* Este es el orden de las imagenes en modo tablet. Recordar que esta lista esta dividida en 2 listas ya que en modo tablet hay 2 columnas de imagenes */


const useTabletPaintings = () => {
...
export default useTabletPaintings;