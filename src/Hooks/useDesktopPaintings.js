/* Este es el orden de las imagenes en modo desktop. Recordar que esta lista esta dividida en 4 listas ya que en modo tablet hay 4 columnas de imagenes */

const useDesktopPaintings = () => {
...
export default useDesktopPaintings;